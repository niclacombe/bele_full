		...
		<table class="table table-striped table-responsive">
			...
			<?php foreach ($searchResults as $searchResult) { ?>
				<tr>
					...
					<td><a href="<?php echo site_url('personnages/getSinglePersonnage') .'/' .$searchResult->Id .'/' .$searchResult->IdIndiv ; ?> "><button class="btn btn-primary"><span class="fa fa-eye fa-reverse"></span></button></a></td>
				</tr>
			<?php } //END FOREACH ?>
		</table>
	</div>
