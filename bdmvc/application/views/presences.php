<script type="text/javascript">
    $(function(){
        ...
        $('#btn-selectActivite').delay(500).on('click', function(event){            
            ...
            load_inscriptions_ajax(idActivite);            
        });
        
      
        function load_inscriptions_ajax(idActivite){    
            $('#listInscriptions').html('<i class="fa fa-cog fa-spin fa-3x fa-fw"></i>');        
            $.ajax({
                'url' : base_url + '/' + controller + '/getPresences', 
                'type' : 'POST',
                'data' : {'idActivite' : idActivite},
                'success' : function(data){ 
                    var container = $('#listPresences');
                    if(data){
                        container.html(data);
                    }
                },
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                ...
                <h2>Voir les présences de l'activité :</h2>
        ...
        <div class="row" id="listPresences">
        </div>
    <!-- /.container-fluid -->
</div>
<!-- /#page-wrapper -->